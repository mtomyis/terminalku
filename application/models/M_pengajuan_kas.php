...
class M_pengajuan_kas extends CI_Model 
{	
	var $table = 'pengajuan_kas';
	var $id_key = "id_pengajuan_kas";
    var $column_order = array('id_pengajuan_kas',null);
    var $column_search = array('uraian','tanggal');
    var $order = array('id_pengajuan_kas' => 'DESC');
