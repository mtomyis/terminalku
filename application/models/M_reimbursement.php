...
{	
	var $table = 'reimbursement';
	var $id_key = "id_reimbursement";
    var $column_order = array('id_reimbursement',null);
    var $column_search = array('no_pengajuan');
    var $order = array('id_reimbursement' => 'DESC');
	...
	public function rekap($tgl1,$tgl2)
	{
